...
const CardSection = () => {
  ...
  return (
    <section className="py-12 bg-gray-50 px-4 sm:px-8 md:px-16 lg:px-20">
        ...
        {cardData.map((card, index) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <Link
                to="/about"
                className="inline-block px-4 py-2 text-sm sm:text-base bg-orange-500 text-white rounded-full hover:bg-orange-600 transition-all"
              >
                Read More
              </Link>
            </div>
